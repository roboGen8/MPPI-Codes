function [states,out_states,cost]=vehicle_dynamics(del_con,dt,states,out_states,j,Afull,Bfull,trim_val,U_opt,V_opt,W_opt,X_optdel,Y_opt,Z_opt,inert_val,cost) 
...
states(:,j) = states(:,j-1) + dt*(Afull*states(:,j-1) + Bfull*del_con(:,j-1,1));
